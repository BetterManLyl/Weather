...
import com.rn.base.okhttp.request.OtherRequest;
 ...
 */
public class OtherRequestBuilder extends OkHttpRequestBuilder<OtherRequestBuilder> implements OtherHasParamsable {
    private RequestBody requestBody;
    private String method;
    private String content;
    protected Map<String, String> params;

    public OtherRequestBuilder() {
